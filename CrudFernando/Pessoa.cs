...
namespace AppPessoa
{
    class Pessoa
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\fhenr\\OneDrive\\Área de Trabalho\\CrudFernando\\DbPessoa.mdf\";Integrated Security=True");
        ...
        {
            string sql = "UPDATE Pessoa SET nome='"+nome+"',cidade='"+cidade+"',celular='"+celular+"',endereco='"+endereco+"',email='"+email+"',data='"+data+"' WHERE Id='"+Id+"'";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.ExecuteNonQuery();
            con.Close();
